...
public class EnvWssBFsWithCLR1scntAndChkDCi_Vpart <T> extends network.Client{
    ...
    public EnvWssBFsWithCLR1scntAndChkDCi_Vpart(String addr, int port, Mode mode, int numOfTasks, boolean[][][] bin_b,int[] BFs1sCnt_b,boolean[][] chkDCi, int len_a, ArrayList<String> PartyB_IDs) {
        this.addr = addr;
        this.port = port;
        this.mode = mode;
        this.bin_b = bin_b;
