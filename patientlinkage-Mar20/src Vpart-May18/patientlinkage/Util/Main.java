                        ...
                        if (PassNumOfOnes) {
                            ...
                            for (int i = 0; i < numOfUsedBFs; i++) {
                                ...
                                for (int Part = 1; Part <= BFHlp1.getnumOfParts(); Part++) {
                                    ...
                                    GenWssBFsWithCLR1scntAndChkDCi_Vpart<GCSignal> gen = new GenWssBFsWithCLR1scntAndChkDCi_Vpart<>(port, Mode.REAL, threads, BFpartData, intNumOf1s, chkPartDCi, BRecsToProcess, PartyA_IDs);
                                    gen.implement();
                        ...
                        if (PassNumOfOnes) {
                            ...
                            for (int i = 0; i < numOfUsedBFs; i++) {
                                ...
                                for (int Part = 1; Part <= BFHlp1.getnumOfParts(); Part++) {
                                    ...
                                    EnvWssBFsWithCLR1scntAndChkDCi_Vpart<GCSignal> env = new EnvWssBFsWithCLR1scntAndChkDCi_Vpart<>(addr, port, Mode.REAL, threads, BFpartData, intNumOf1s, chkPartDCi, ARecsToProcess, PartyB_IDs);
                                    env.implement();
