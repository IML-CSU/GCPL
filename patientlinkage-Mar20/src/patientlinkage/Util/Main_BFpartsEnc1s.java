 ...
 * @author cf
 */
public class Main_BFpartsEnc1s {
            ...
            switch (party) {
                case "generator":
                    ...
                    if (useChkDci) {
                        ...
                        System.out.println((new Date())+":Gen. ((V1)) starts patientlinkage algorithm with :\n -Partitioned BFs \n-filtring using chk DC for those matched by any filter ...");

                        if (PassNumOfOnes) {
                            boolean[][][] numOf1s;
                            numOf1s = help1.numOfOnesInBFs;

                            System.out.println(" patientlinkage With Enc BF #1s passed...");
                    ...
                    if (useCombBF) {
                        ...
                        System.out.println((new Date())+":Gen. starts patientlinkage algorithm with Comb. of BFs ...");
                        ...
                        System.out.println((new Date())+":Gen. starts patientlinkage algorithm single BFs ...");
                        // t0 = System.currentTimeMillis();
                        if (PassNumOfOnes) {
                            boolean[][][] numOf1s;
                            numOf1s = help1.numOfOnesInBFs;
                ...
                case "evaluator":
                    ...
                    if (useChkDci) {
                        System.out.println((new Date())+": Eval.((V1)) starts patientlinkage algorithm with :\n -Partitioned BFs \n-filtring using chk DC for those matched by any filter ...");
...
//                                    }
                    ...
                    if (useCombBF) {
                        System.out.println((new Date())+":Eval. starts patientlinkage algorithm with Combs of BFs ...");
                        t0 = System.currentTimeMillis();
                        if (PassNumOfOnes) {
                            boolean[][][] numOf1s;
                            numOf1s = help1.numOfOnesInBFs;
                        ...
                        System.out.println((new Date())+":Eval. starts patientlinkage algorithm single BFs ...");
                        t0 = System.currentTimeMillis();
                        if (PassNumOfOnes) {
                            boolean[][][] numOf1s;
                            numOf1s = help1.numOfOnesInBFs;
